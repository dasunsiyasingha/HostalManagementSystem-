                          ...
                          <form>
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-group-default">
                                  <label>Nic</label>
                                  <input id="addnic" type="text" class="form-control" placeholder="fill Nic Number" />
                                </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-group-default">
                                  <label>Age</label>
                                  <input id="addage" type="text" class="form-control" placeholder="fill age" />
                                </div>
                              </div>
